...
import { getQuizzesOverview } from './data';

export function QuizzesList() {
  const { t } = useTranslation();
  const quizzes = getQuizzesOverview();
              ...
              <Card key={quiz.quizId}>
                <CardContent className="space-y-3 p-5">
                  ...
                  <p className="text-xs text-[rgba(249,246,240,0.55)]">
                    {t('studentPages.dashboard.quizzes.attempts', {
                  ...
                  {quiz.bestScore !== undefined && (
                    <Badge variant="success">
                      {t('studentPages.dashboard.quizzes.bestScore', {
