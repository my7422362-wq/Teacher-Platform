...
import { useTeacherExam, ExamResults } from '@/features/teacher/components/QuizzesExams';
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <>
          <PageHeader title={exam.title} description={t('teacherPages.quizzesExams.results.title')} />
